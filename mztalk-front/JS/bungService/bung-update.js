...
window.onload = function(){
    ...
    for(let i = 0 ; i < imageInfo.length ;  i++){
        ...
        document.getElementById("carouselExampleControls").innerHTML += `<span class="${objectData}"><span class = "imageName">${imageInfo[i].imageName}</span><span class="count-div"></span><span id = "fileDelete" style="color: gray;margin-left: 5px; cursor: pointer;" onclick="deleteFile('${objectData}');">X<br></span></span></span>`;
